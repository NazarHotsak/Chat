...
namespace Advanced.Models
{
    public class IdentitySeedData
    {
        ...
        public static async Task CreateAdminAccountAsync(IServiceProvider serviceProvider, IConfiguration configuration)
        {
            ...
            string password = configuration["Data:AdminUser:Password"] ?? "secretJJ0.";
        ...
        //private static async Task CreateAcount1(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager)
        //{
